...
if ($con->connect_errno) {
    ...
    $opentime = $con->query("SELECT opentime FROM breakfast WHERE id=6 AND day =6")->fetch_object()->opentime;
    $tj->setopnTime(6,"brkfst",$opentime);
/*    for ($x = 0; $x < 7; $x++  ){
