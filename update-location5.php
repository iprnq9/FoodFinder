...
//            echo "      </div>";
    ...
    echo "   <option value=\"update-location5.php?id=$id&edit=name\">Update Name</option>\n";
    echo "   <option value=\"update-location5.php?id=$id&edit=hours\">Update Hours</option>\n";
    echo "   <option value=\"update-location5.php?id=$id&edit=description\">Update Description</option>\n";
    echo "   <option value=\"update-location5.php?id=$id&edit=cover_photo\">Update Cover Photo</option>\n";
    echo "   <option value=\"update-location5.php?id=$id&edit=card_1\">Update Profile Card 1</option>\n";
    echo "   <option value=\"update-location5.php?id=$id&edit=card_2\">Update Profile Card 2</option>\n";
    echo "   <option value=\"update-location5.php?id=$id&edit=card_3\">Update Profile Card 3</option>\n";
    echo "   <option value=\"update-location5.php?id=$id&edit=menu\">Update Menu</option>";
    echo "</select>\n";
