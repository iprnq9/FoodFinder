    ...
    { ?>
        <form class="col s12" method="post" action="<?php $_PHP_SELF ?>">
            <div class="row" style="padding: 10px;">
                <div class="input-field col s6">
                    <i class="material-icons prefix">label_outline</i>
                    <textarea class="materialize-textarea" id="card1_paragraph" name="card1_paragraph" type="text" length="120" placeholder="Currently: <?php echo $objArray[$id-1]->getParagraph(0);  ?>"></textarea>
